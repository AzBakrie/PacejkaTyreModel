...
% amended to be only for hoosier 18.9 x 7.5 10 R25B rim width 7 
% runs 21, 22, 35, 36 from Round 6
run1 = load('B1654run21.mat'); % latitude data 
run2 = load('B1654run22.mat'); % latitude data

run3 = load('B1654run35.mat'); % longitude data - hoosier 18.0 x 7.5 10 R25B rim width 7
run4 = load('B1654run36.mat'); % longitude data - hoosier 18.0 x 7.5 10 R25B rim width 7
...
%% FY0 FOR THE TYRE - HOOSIER 16.0X6.0-10 R25B ITEM 43070 - From Round 8 
% need to check this only changes the fy0 parameters
run5 = load('B1965raw12.mat');
run6 = load('B1965raw13.mat');
tyre_model.fy0 = FYclass(run5, run6);
tyre_model.fy0 = tyre_model.fy0.createDataBins(false);
tyre_model.fy0 = tyre_model.fy0.create_sweeps(1000, false);
tyre_model.fy0 = tyre_model.fy0.fitCubicSpline();
tyre_model.fy0 = tyre_model.fy0.generateSplinePoints();
